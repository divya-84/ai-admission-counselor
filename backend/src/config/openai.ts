...
const streamMockResponse = async (
  ...
  const responses = [
    ...
    `Hi! Welcome to the ABES Admission Counsellor. I am your virtual admission assistant and I'm here to help you with admissions, eligibility, courses, fee structure, documents, counselling process, scholarships, placements, hostel information, and other queries related to ABES Engineering College.`,
  ];
