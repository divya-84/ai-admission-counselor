            ...
            <div className="space-y-1">
              ...
              <div className="relative">
                ...
                <select
                  ...
                  className="w-full bg-slate-950 border border-slate-800 rounded-lg pl-10 pr-4 py-2 text-slate-100 focus:border-indigo-500 focus:outline-none transition-all text-sm"
                >
